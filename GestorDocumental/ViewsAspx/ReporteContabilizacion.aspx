<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true"
    CodeBehind="ReporteContabilizacion.aspx.cs" Inherits="GestorDocumental.ViewsAspx.ReporteContabilizacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style type="text/css">
        ...
        #txtCodigoBarras, #txtNoDocumento
        {
            width: 20%;
            height: 1.5em;
            border-radius: 5px;
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div id="divContenerdor">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <fieldset id="FiltrosPrincipales" class="scheduler-border">
                ...
                <table id="tableDatos">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFechaIni" runat="server" Width="70%" ClientIDMode="Static" required="required"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtFechaFin" runat="server" Width="70%" ClientIDMode="Static" required="required"></asp:TextBox>
            ...
            <fieldset id="FiltrosEspecificos" disabled="disabled" class="scheduler-border">
                ...
                <input type="text" id="txtCodigoBarras" runat="server" name="name" value="" clientidmode="Static" />
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" id="chkNoDocumentos" name="" value=" " />
                <label>
                No. Documento:</label>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Font-Names="Verdana"
            ...
            <LocalReport ReportPath="Reportes\ReporteContabilizacion.rdlc" EnableHyperlinks="True"
                    ...
                    if (chek == true) {
                        ...
                        switch (idCampo) {
                            ...
                            case "chkCodBarras":
                                ...
                                $("#txtCodigoBarras").val("");
                                $("#txtNoDocumento").removeAttr("disabled");
                                $("#chkNoDocumentos").attr("checked", true);
                                break;
                            case "chkNoDocumentos":
                                $("#txtNoDocumento").attr("disabled", "disabled");
                                $("#txtNoDocumento").val("");
                                $("#txtCodigoBarras").removeAttr("disabled");
                                $("#chkCodBarras").attr("checked", true);
                                break;
                            case "chkFiltrosPrincipales":
                                $("#FiltrosPrincipales").attr("disabled", "disabled");
                                $("#FiltrosEspecificos").removeAttr("disabled");
