...
{
    public partial class ReporteEstadoNegocios : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var result = data.spValidaAccesoModulo(idRol, "/ViewsAspx/ReporteEstadoNegocios.aspx").FirstOrDefault();
            ...
            {
                ((Label)base.Master.FindControl("lblNegocio")).Text = "Consulta  estado negocios";
            }
            else
            {
        ...
        protected void tnGenerar_Click(object sender, EventArgs e)
        {
            ...
            this.ReportViewer1.LocalReport.ReportPath = base.Server.MapPath("../Reportes/Report1.rdlc");
            item.Name = "DataSet1";
