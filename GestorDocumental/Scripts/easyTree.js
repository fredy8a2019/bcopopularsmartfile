    ...
    $.fn.EasyTree = function (options) {
        ...
        this.each(function () {
            ...
            if (options.selectable) {
                ...
                //    var li = $(this).parent().parent();
                //    if (li.hasClass('li_selected')) {
                //        alert("agregamos clase");
                //        //$(this).attr('title', options.i18n.selectTip);
                //        $(this).attr('title', options.i18n.selectTip);
                //        $(li).removeClass('li_selected');
                //    }
                //    else {
                //        alert("removemos clase");
                //        $(easyTree).find('li.li_selected').removeClass('li_selected');
                //        $(this).attr('title', options.i18n.unselectTip);
                //        $(li).addClass('li_selected');
                //    }
                ...
                $(easyTree).find('li > span').click(function (e) {
                    
                    var li = $(this).parent();
                    if (li.hasClass('li_selected')) {
                        //$(this).attr('title', options.i18n.selectTip);
                        $(this).find('a').attr('title', options.i18n.selectTip);
                        $(li).removeClass('li_selected');
                    }
                    else {
                        $(easyTree).find('li.li_selected').removeClass('li_selected');
                        $(this).find('a').attr('title', options.i18n.unselectTip);
                        $(li).addClass('li_selected');
                    }
