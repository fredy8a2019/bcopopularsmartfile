    ...
    <div>
        <script type="text/javascript">
            ...
            function confirmarTiquet() {
                var noTiquet = <%= Request.QueryString["noTiquet"].ToString() %>
                bootbox.dialog({
                    message: "<h4>Su solicitud ha sido procesada, su número de Tiquet es: " + "<b>" + noTiquet + "</b>" + "</h4>",
                    ...
                    buttons: {
                        success: {
                            ...
                            callback: function () {
                                window.location.href = "/Solicitud/Index";
                            }
                        }
                    }
                });
